...
{
    class AntiSiege : Turret
    {
        public AntiSiege(DestroyableObject bearer, Vector3 pos, TowARDefense parent_f)
        ...
        protected override void Init()
        {
            range = 70;
            reloadTime = 6;
            weaponType = GameWeapons.AntiSiege;

            gNode.Model = parent.graSys.antiSiegeTurretModel;
