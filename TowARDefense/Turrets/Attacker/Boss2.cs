...
namespace TowARDefense.Turrets.Attacker
{
    class Boss2 : Turret
    {
        ...
        public Boss2(DestroyableObject bearer, Vector3 pos, TowARDefense parent_f)
        ...
        protected override void Init()
        {
            ...
            gNode.Model = parent.graSys.boss2TurretModel;

            tNode.AddChild(gNode);

            tNode.Scale = new Vector3(1.5f, 1.5f, 1.5f);
